...
os.system(
    "scp -i " + key_path + " build_r.sh ec2-user@" + my_server_ip + ":/home/ec2-user/"
)
os.system(
    "ssh -i " + key_path + " ec2-user@" + my_server_ip + " 'chmod +x build_r.sh'"
)
os.system(
    "ssh -i " + key_path + " ec2-user@" + my_server_ip + " './build_r.sh '" + options.r_version
)

if options.action == "build_r":
    os.system(
        "scp -i " + key_path + " ec2-user@" + my_server_ip + ":/opt/R/R.zip ."
    )
